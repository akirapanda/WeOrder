...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { keyword: @keyword.keyword, reply_content: @keyword.reply_content, type: @keyword.type }
    end
  ...
  test "should update keyword" do
    patch :update, id: @keyword, keyword: { keyword: @keyword.keyword, reply_content: @keyword.reply_content, type: @keyword.type }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
