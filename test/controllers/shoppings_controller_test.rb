...
class ShoppingsControllerTest < ActionController::TestCase
  ...
  test "should create shopping" do
    assert_difference('Shopping.count') do
      post :create, shopping: { amount: @shopping.amount, customer_address: @shopping.customer_address, customer_name: @shopping.customer_name }
    end
  ...
  test "should update shopping" do
    patch :update, id: @shopping, shopping: { amount: @shopping.amount, customer_address: @shopping.customer_address, customer_name: @shopping.customer_name }
    assert_redirected_to shopping_path(assigns(:shopping))
  end
