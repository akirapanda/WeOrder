class Admin::WeixinMessagesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @weixin_message.save
        format.html { redirect_to [:admin,@weixin_message], notice: 'Weixin message was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @weixin_message.update(weixin_message_params)
        format.html { redirect_to [:admin,@weixin_message], notice: 'Weixin message was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_weixin_messages_url }
      format.json { head :no_content }
    end
  end
